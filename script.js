...
function getUnlockedProducers(data) {
  ...
  let unlockedProducers = data.producers.filter(
    (producers) => producers.unlocked === true
  );
...
producerContainer.addEventListener("click", () => {
  buyButtonClick("click", data);
});
